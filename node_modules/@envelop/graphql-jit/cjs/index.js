...
const useGraphQlJit = (compilerOptions = {}, pluginOptions = {}) => {
    ...
    const jitCache = typeof pluginOptions.cache !== 'undefined' ? pluginOptions.cache : (0, tiny_lru_1.default)(DEFAULT_MAX, DEFAULT_TTL);
    function getCacheEntry(args) {
        ...
        if (!cacheEntry) {
            const compilationResult = (0, graphql_jit_1.compileQuery)(args.schema, args.document, (_a = args.operationName) !== null && _a !== void 0 ? _a : undefined, compilerOptions);
